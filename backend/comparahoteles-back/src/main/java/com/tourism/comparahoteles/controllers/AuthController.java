...
import com.tourism.comparahoteles.payload.request.LoginRequest;
import com.tourism.comparahoteles.payload.request.SignupRequest;
import com.tourism.comparahoteles.payload.response.JwtResponse;
...
import com.tourism.comparahoteles.security.jwt.JwtUtils;
import com.tourism.comparahoteles.security.services.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
		...
		return ResponseEntity.ok(new JwtResponse(jwt, userDetails.getId(), userDetails.getUsername(),
				userDetails.getName(), userDetails.getSurname(), userDetails.getEmail(), roles));
	}
